(function() {let __HMR_ID = "0.mrry3jok8t";
...
const extensionDescription = { "description": "Extension description", "message": "Chrome extension boilerplate developed with Vite, React and Typescript" };
const extensionName = { "description": "Extension name", "message": "Chrome extension boilerplate" };
const toggleTheme = { "message": "Toggle theme" };
const injectButton = { "message": "Click to inject Content Scripts" };
const greeting = { "description": "Greeting message", "message": "Hello, My name is $NAME$", "placeholders": { "name": { "content": "$1", "example": "John Doe" } } };
const hello = { "description": "Placeholder example", "message": "Hello $1" };
const displayErrorInfo = { "message": "Error occur" };
const displayErrorDescription = { "message": "Sorry, something went wrong while loading the page." };
const displayErrorDetailsInfo = { "message": "Error details:" };
const displayErrorUnknownErrorInfo = { "message": "Unknown error" };
const displayErrorReset = { "message": "Run Again" };
const localeJSON = {
...
const translate = (key, substitutions) => {
  ...
  if (localeValues.placeholders) {
    Object.entries(localeValues.placeholders).forEach(([key2, { content }]) => {
      if (content) {
...
const t$1 = (...args) => removePlaceholder(translate(...args));
const t = t$1;
var react = { exports: {} };
...
const withSuspense = (Component, SuspenseComponent) => (props) => jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: SuspenseComponent, children: jsxRuntimeExports.jsx(Component, { ...props }) });
...
const withErrorBoundary = (Component, FallbackComponent) => function WithErrorBoundary(props) {
  return jsxRuntimeExports.jsx(ErrorBoundary, { FallbackComponent, children: jsxRuntimeExports.jsx(Component, { ...props }) });
};
var client = { exports: {} };
...
function requireReactDomClient_production() {
  ...
  var ContextOnlyDispatcher = {
    ...
    useState: function(initialState2) {
      ...
      var queue2 = initialState2.queue, dispatch = dispatchSetState.bind(null, currentlyRenderingFiber, queue2);
...
const ToggleButton = ({ className, children, ...props }) => {
  ...
  return jsxRuntimeExports.jsx("button", { className: cn("mt-4 rounded border-2 px-4 py-1 font-bold shadow hover:scale-105", isLight ? "border-black bg-white text-black" : "border-white bg-black text-white", className), onClick: exampleThemeStorage.toggle, ...props, children });
};
var cssUnit = {
  cm: true,
  mm: true,
...
const LoadingSpinner = ({ size }) => jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center", children: jsxRuntimeExports.jsx(RingLoader, { size: size ?? 100, color: "aqua" }) });
const WarningIcon = ({ className }) => jsxRuntimeExports.jsx("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", className, children: jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" }) });
const ErrorHeader = () => jsxRuntimeExports.jsxs("div", { className: "text-center", children: [jsxRuntimeExports.jsx(WarningIcon, { className: "mx-auto h-24 w-24 text-red-500" }), jsxRuntimeExports.jsx("h2", { className: "mt-6 text-3xl font-extrabold text-gray-900", children: t("displayErrorInfo") }), jsxRuntimeExports.jsxs("p", { className: "mt-2 text-sm text-gray-600", children: [t("displayErrorDescription"), "."] })] });
const ErrorResetButton = ({ resetErrorBoundary }) => jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: jsxRuntimeExports.jsx("button", { onClick: resetErrorBoundary, className: "inline-flex items-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2", children: t("displayErrorReset") }) });
const ErrorStackTraceList = ({ error }) => jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-lg bg-white shadow", children: jsxRuntimeExports.jsx("div", { className: "px-4 py-5 sm:p-6", children: jsxRuntimeExports.jsxs("div", { className: "text-sm text-gray-500", children: [jsxRuntimeExports.jsx("p", { className: "mb-2 font-medium text-gray-700", children: t("displayErrorDetailsInfo") }), jsxRuntimeExports.jsxs("div", { className: "overflow-auto rounded-md bg-red-50 p-4", children: [jsxRuntimeExports.jsx("p", { className: "break-all font-mono text-red-700", children: (error == null ? void 0 : error.message) || t("displayErrorUnknownErrorInfo") }), (error == null ? void 0 : error.stack) && jsxRuntimeExports.jsxs("details", { className: "mt-3", children: [jsxRuntimeExports.jsx("summary", { className: "cursor-pointer text-sm text-red-700", children: "Stack trace" }), jsxRuntimeExports.jsx("pre", { className: "mt-2 overflow-auto p-2 text-xs text-red-800", children: error == null ? void 0 : error.stack })] })] })] }) }) });
const ErrorDisplay = ({ error, resetErrorBoundary }) => jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center bg-gray-50 px-4 py-6 sm:px-6 lg:px-8", children: jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md space-y-8", children: [jsxRuntimeExports.jsx(ErrorHeader, {}), jsxRuntimeExports.jsx(ErrorStackTraceList, { error }), jsxRuntimeExports.jsx(ErrorResetButton, { resetErrorBoundary })] }) });
var cjs;
var hasRequiredCjs;
function requireCjs() {
...
const NewTab = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("App", isLight ? "bg-slate-50" : "bg-gray-800"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: cn("App-header", isLight ? "text-gray-900" : "text-gray-100"), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: goGithubSite, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: chrome.runtime.getURL(logo), className: "App-logo", alt: "logo" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "Edit ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "pages/new-tab/src/NewTab.tsx" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h6", { children: "The color of this paragraph is defined using SASS. test" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleButton, { onClick: exampleThemeStorage.toggle, children: t("toggleTheme") })
  ] }) });
};
const NewTab$1 = withErrorBoundary(withSuspense(NewTab, /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, {})), ErrorDisplay);
const init = () => {
...
init();
//# sourceMappingURL=index-CTllrTnV.js.map
